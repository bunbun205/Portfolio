	...
	return (
		<section className="py-10">
			...
			<p className="mb-2">
				...
				Find the project on the <a href="https://github.com/bunbun205/portfolio-template" className="hover:underline text-red-200 hover:text-red-600">github repository</a>.
			</p>
